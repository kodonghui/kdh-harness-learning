...
| Phase 2 | Context & Memory — tokens, memory, prompts | 3 |
| Phase 3 | Execution — patterns, multi-agent, hooks | 3 |
| Phase 4 | Safety — state, failure/recovery, security | 3 |
| Phase 5 | Ops — observability, cost/perf, evaluation | 3 |
...
| Phase 2 | 컨텍스트와 메모리 — 토큰, 메모리, 프롬프트 | 3 |
| Phase 3 | 실행 — 패턴, 멀티에이전트, 훅 | 3 |
| Phase 4 | 안전 — 상태, 실패/복구, 보안 | 3 |
| Phase 5 | 운영 — 관측성, 비용/성능, 평가 | 3 |
